...
/**
 * This class holds information about on test. Depending upon <a
 * href="http://sourceforge.net/tracker/index.php?func=detail&aid=2033150&group_id=15278&atid=365278" >JUnit bug
 * 2033150</a>, this class should be considered for implementing {@link Serializable}.
 * 
...
public class TestInfo {
	...
	/**
	 * public TestInfo(Test test) { if (test instanceof TestCase) { testClassName = test.getClass().getName(); testName
